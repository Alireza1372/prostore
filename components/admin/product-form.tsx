...
const ProductForm = ({ type, product, productId }: ProductFormProps) => {
  ...
  // type InsertProductFormValues = z.infer<typeof insertProductSchema>;
                      ...
                      <div className="flex flex-start space-x-2">
                        {images.map((image) => (
                          <Image
                            ...
                            src={image}
                            alt="product image"
                            className="w-20 h-20 object-cover object-right rounded-sm"
                            width={100}
                            height={100}
                          />
                        ))}
